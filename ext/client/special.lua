...
local NightVision = { -- Night Vision Goggles
    ...
    TonemapComponentData = {
        ...
        bloomScale = Vec3(0.04, 0.04, 0.04),
        tonemapMethod = 1
    },
    FogComponentData = {
        enable = true,
    ...
    VignetteComponentData = {
        enable = true,
        realm = 0,
        scale = Vec2(2.0, 1.25), --Aspect ratio = 1,0909090909090909090909090909091
        color = Vec3(0.05900000035762787,0.09399999678134918,0.06499999761581421),
        exponent = 0.0,
...
local NightVisionVehicle = { -- Night Vision Goggles Vehicles
    ...
    TonemapComponentData = {
        ...
        middleGray = 0.75,
        exposureAdjustTime = 10,
        bloomScale = Vec3(0.01, 0.01, 0.01),
        tonemapMethod = 1
    },
    FogComponentData = {
        enable = true,
